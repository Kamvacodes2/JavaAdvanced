...
public class SerializeTest {
    ...
    public static void main(String[] args) {
        String directory = "C:\\BootCamp\\Java Advanced\\Book\\chapter13\\practice\\practice2" ;
        String cartId = null;
        ShoppingCart cart = null;
        System.out.print("Enter the ID of the cart file to create and serialize or q exit: ");
